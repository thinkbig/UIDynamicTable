...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // 1. Create a new instance for list view controller.
    ...
    // Release Navigation controller instance coz it is already retained in root view controller.
    [rootViewController release];
    
    // Retain the window instance.
    self.window = window;
    [window release];
